...
> 如果下载文件是文本类型的(如: .txt, .js 之类的), 那么用 responseType: 'text'也可以, 但是如果下载的文件是图片, 视频之类的, 就得用 arraybuffer 或 blob，更多详情请[查看 MDN](https://developer.mozilla.org/zh-CN/docs/Web/API/XMLHttpRequest/responseType)
